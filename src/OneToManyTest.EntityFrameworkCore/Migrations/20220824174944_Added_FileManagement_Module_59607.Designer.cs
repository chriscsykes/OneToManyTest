...
{
    [DbContext(typeof(OneToManyTestDbContext))]
    [Migration("20220824174944_Added_FileManagement_Module_59607")]
    partial class Added_FileManagement_Module_59607
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OneToManyTest.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("OneToManyTest.Hobbies.Hobby", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("YearsPerformed")
                        .HasColumnType("int")
                        .HasColumnName("YearsPerformed");

                    b.HasKey("Id");

                    b.ToTable("AppHobbies", (string)null);
                });

            modelBuilder.Entity("OneToManyTest.Hobbies.HobbyCustomer", b =>
                {
                    ...
                    b.HasKey("HobbyId", "CustomerId");

                    b.HasIndex("CustomerId");

                    b.HasIndex("HobbyId", "CustomerId");

                    b.ToTable("AppHobbyCustomer", (string)null);
                });

            modelBuilder.Entity("OneToManyTest.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OneToManyTest.Customers.Customer", b =>
                {
                    b.HasOne("OneToManyTest.Orders.Order", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OneToManyTest.Hobbies.HobbyCustomer", b =>
                {
                    b.HasOne("OneToManyTest.Customers.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("OneToManyTest.Hobbies.Hobby", null)
                        .WithMany("Customers")
